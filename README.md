...
``` bash
$ ./letsencrypt.sh -c -t dns-01 -d looneytoons.acme.com -k ./hooks/manual/manual_hook.rb
Processing looneytoons.acme.com
 + Signing domains...
 + Generating private key...
 + Generating signing request...
 + Requesting challenge for looneytoons.acme.com...
Create TXT record for the domain: "_acme-challenge.looneytoons.acme.com". TXT record:
"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
Press enter when DNS has been updated...

Found XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX. match.
 + Responding to challenge for looneytoons.acme.com...
Challenge complete. Please delete this TXT record now (or in bulk later). Press enter to continue...
 + Challenge is valid!
